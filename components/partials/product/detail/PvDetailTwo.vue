			...
			<div class="container">
				...
				<div class="sticky-detail">
					<div class="sticky-product-name">
						...
						>
							<template v-if="!product.is_sale">
								<span class="product-price">R{{ product.price | priceFormat }}</span>
							</template>

							<template v-else>
								<span class="product-price">R{{ product.sale_price | priceFormat }}</span>
								<span class="old-price">R{{ product.price | priceFormat }}</span>
							</template>
						</div>
						...
						>
							<template v-if="minPrice !== maxPrice">
								<span class="product-price">R{{ minPrice | priceFormat }} &ndash; ${{ maxPrice | priceFormat }}</span>
							</template>

							<template v-else>
								<span class="product-price">R{{ minPrice | priceFormat }}</span>
							</template>
						</div>
					</div>
					<div class="ratings-container">

<template>
    <div>
                ...
                <ul class="config-size-list">
                    ...
                    >
                        ...
                        >
                            ...
                            <img v-else :src="`${baseUrl}${item.thumbnail[0]}`" alt="thumb-image" />
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <div class="product-action">
            <vue-slide-toggle :open="isPriceShow" v-if="product.variants.length > 0">
                ...
                <div class="price-box product-filtered-price" v-else>
                    <template v-if="product.variants[curIndex].sale_price">
                        ...
                        <span
                            class="product-price"
                        >R{{ product.variants[curIndex].sale_price | priceFormat }}</span>
                    </template>

                    <template v-else>
                        <span
                            class="product-price"
                        >R{{ product.variants[curIndex].price | priceFormat }}</span>
                    </template>
                </div>
            </vue-slide-toggle>
            ...
            <nuxt-link to="/pages/cart" class="btn btn-gray view-cart d-none">View cart</nuxt-link>
        </div>

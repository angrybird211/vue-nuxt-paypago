<template>
	<div class="header-icon mb-0 header-search header-search-inline header-search-category w-lg-max d-none d-sm-block">
		<a
			href="javascript:;"
			class="search-toggle"
			role="button"
		...
		>
			<div class="header-search-wrapper">
				...
				<button
					class="btn icon-magnifier pb-1 bg-white"
					title="search"
					type="submit"
				></button>
					...
					>
						...
						>
							...
							<div class="search-price">
								...
								>R{{ product.minPrice.toFixed(2) }}</div>
								...
								<template v-else>
									...
									>
										<span class="new-price">R{{ product.minPrice.toFixed(2) }}</span>
										<span class="old-price">R{{ product.maxPrice.toFixed(2) }}</span>
									</div>
									<div
										class="product-price mb-0"
										v-else
									>R{{product.minPrice.toFixed(2)}} - ${{product.maxPrice.toFixed(2)}}</div>
								</template>
							</div>
							<!-- <a
								href="javascript:;"
